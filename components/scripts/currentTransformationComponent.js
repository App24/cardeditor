function drawCurrentTransformation(canvas, data) {
    const { currentTransformation_textAlign, currentTransformation_textBaseline, currentTransformation_text, currentTransformation_strokeSize, currentTransformation_positionX, currentTransformation_positionY } = data;
    let { currentTransformation_textColor, currentTransformation_strokeColor } = data;

    currentTransformation_textColor = currentTransformation_textColor.removeHash();
    currentTransformation_strokeColor = currentTransformation_strokeColor.removeHash();
