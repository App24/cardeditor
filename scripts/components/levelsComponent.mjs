...
export class LevelsComponent extends TextComponent {
    constructor() {
        super("Level Text", "levels", 50, {
            defaultX: 10, defaultY: 5,
            defaultText: "0", defaultTextAlign: "left", defaultTextBaseline: "top",
            defaultTextColor: "#ffffff", hasTextSize: true,
            defaultStrokeColor: "#000000", strokeData: {
                default: 0,
                min: 0,
                max: 5
            }
